...
sealed class BottomNavigationScreens(route: String, icon: ImageVector, label: String) {
    ...
    object Favorite:BottomNavigationScreens(Routes.FavoritesScreen.route, Icons.Filled.Favorite, "Favorite")
    object Settings: BottomNavigationScreens(Routes.SettingsScreen.route, Icons.Filled.Home, "Settings")
